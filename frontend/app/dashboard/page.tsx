...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([getStatsOverview(), getStatsByCategory(), getStatsByBrand(), getBestPriceStores(), getProducts()])
      .then(([overviewData, categoryData, brandData, storeData, productsData]) => {
        if (cancelled) return;
        ...
        setSelectedProductId((current) => current || overviewData.cheapest?.product._id || productsData[0]?._id || "");
      })
      .catch((err) => {
